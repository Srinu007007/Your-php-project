...
$query="SELECT * FROM darshanbooking WHERE useremail='$userprofile' && dateof='$date' && amount =$amount && paymenttype ='$cardtype' ";
...
//echo $result['bookingdate'];
//echo $result['totalmemebers'];
...
<div class="container">
<center><h3 style='margin-bottom:20px;margin-top:30px;'>Your Payment Successfully compeleted..</h3>

<p>Darshan ticket Id Number is : KADTIDE0<?php echo $result['id']; ?></p>

Booking time <b><?php echo $result['timeof']; ?></b> and Date is <b><?php echo $result['dateof']; ?></b>
