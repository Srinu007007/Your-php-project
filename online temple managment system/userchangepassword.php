...
$query1="UPDATE users SET  password='$newpwd' where email='$userprofile'";
...
<b><label> Old Password: </label> <b><br>
...
<div class="col-lg-4">
<div class="form-group">
<b><label> New Password: </label> <b><br>
...
<div class="col-lg-4">
<div class="form-group">
<b><label> Re-entry New Password: </label> <b><br>

<input type="password" name="rnewpwd" id="rnewpwd" value="" class="form-control">
</div>
</div>
<br>
<input type="submit" name="changepassword" value="Change Password" class="btn btn-primary" style="background-color:#333300;border:none;">
