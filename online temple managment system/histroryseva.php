...
<table class="table" style="border:1px solid black;padding:10px;">
  <thead>
    <tr>
      <th scope="col">#</th>
      <th scope="col">Receipt Number</th>
	  <th scope="col">Name(Booked)</th>
	  <th scope="col">Mobile Number</th>
      <th scope="col">Temple name</th>
      <th scope="col">Sevas Name</th>
	   <th scope="col">Sevas Type</th>
	   <th scope="col">Sevas Cost</th>
...
$query="SELECT * FROM sevasbooking WHERE useremail='$userprofile'";
$data=mysqli_query($conn,$query);
$total=mysqli_num_rows($data);
//$result=mysqli_fetch_assoc($data);
//echo $result['sevatype'];
if($total==0){
echo 'no records';
}else{
...
<?php $typeandcost=$result['sevatype'];
//echo $typeandcost;
...
//echo $res[0];?>
      ...
      <th scope="row">1</th>
      <td>SEVAEID0<?php echo $result['id'];?></td>
      <td><?php echo $result['name']; ?></td>
      <td><?php echo $result['mbl']; ?></td>
      <td>Your temple name</td>
