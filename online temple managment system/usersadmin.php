                            ...
                            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="adminindex.php">Logout</a>
...
$query1="SELECT * FROM `users` WHERE Register_time >= DATE(NOW()) - INTERVAL $days DAY;";
...
echo 'no records';
	...
	?>
        <tbody>
            <tr>
                <td></td>
                <td>USDRID0<?php echo $result1['id'];?></td>
