    ...
    <body>
        <div class="d-flex" id="wrapper">
			...
			<h5 >Welcome back, Admin</h5>
                ...
                <!-- Page content-->
                <div class="container-fluid">
                    <h1 class="mt-4">Darshan</h1>
					<form action="" method="post" >
<div class="row" style="margin-left:60%">
<div class="col-lg-4">
					<select name="days" class="form-control">
						<option value="Choose">Choose</option>
						<option value="2">1 day(s)</option>
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                ...
                <th>Dharshan Date</th>
				<th>Dharshan Time</th>
				<th>Member of Peoples</th>
				

				<th>User Registered E-mail</th>
...
$query1="SELECT * FROM `darshanbooking` WHERE bookingdate >= DATE(NOW()) - INTERVAL $days DAY";
...
echo 'no records';
	...
	?>
        <tbody>
            <tr>
                <td></td>
                <td>KADTIDE0<?php echo $result1['id']; ?></td>
                <td><?php echo $result1['dateof'];?></td>
				<td><?php echo $result1['timeof'];?></td>
				<td><?php echo $result1['totalmemebers'];?></td>
				<td><?php echo $result1['useremail'];?></td>
				
                <td><?php echo $result1['city'];?>, <?php echo $result1['state']; ?>,<?php echo $result1['country'];?></td>

				<td><?php echo $result1['message'];?></td>
				<td><?php echo $result1['identityproof'];?></td>
                <td><?php echo $result1['identityproofno'];?></td>
				
                <td><?php echo $result1['amount'];?></td>
				<td><?php echo $result1['paymenttype'];?></td>
