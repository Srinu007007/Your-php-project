...
<form class="credit-card" action="" method="POST" style="margin-top:10%;" onsubmit="return val()">
  ...
  <div class="form-body">
    <!-- Card Number -->
    <input type="text" class="card-number" style="padding:10px;" id="cardnumber" value=""placeholder="UPI Number">
    <input type="hidden" name="cardtype" value="UPI">
    <!-- Date Field -->
 ...
 Card Verification Field -->
  <!--   <div class="card-verification">
      <div class="cvv-input">
        <input type="text" placeholder="CVV" style="padding:10px;">
      </div>
