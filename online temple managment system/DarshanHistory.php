...
$username=$_SESSION['user_name'];
$query="SELECT * FROM darshanbooking where useremail='$username'";
...
echo 'no records';
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td>KADTIDE0<?php echo $result['id']; ?></td>
      <td>Ayyapa temple</td>
      <td><?php echo $result1['fname']; ?>  <?php echo $result1['lname']; ?></td>
      <td><?php echo $result['useremail']; ?></td>
		<td><?php echo $result1['mbl']; ?></td>
		
		<td><a href="viewbookingdetails.php?rn=<?php echo $result['id']; ?>" class="btn btn-primary btn-sm">View Detail</a></td>
    </tr>
