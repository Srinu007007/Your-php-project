...
<div class="header">
			<div class="container" >
					<div class="row" >
						...
						<div class="col-lg-6" >
								<img src="img/icon.png" width="70" height="70" id="icon" style="margin-right:20px;" class="rounded" border="0" alt="">
...
<p style="text-align:justify;margin-top:10px;"> kuram On the Insert tab, the galleries include items that are designed to coordinate with the overall look of your document. You can use these galleries to insert tables, headers, footers, lists, cover pages, and other document building blocks. When you create pictures, charts, or diagrams, they also coordinate with your current document look.
